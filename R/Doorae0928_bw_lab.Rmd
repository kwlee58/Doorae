...
```{r, echo=FALSE, results='asis'}
kable(as.matrix(comm_stat.org_str.reg.ftbl))
```
...
```{r, echo=FALSE, results='asis'}
kable(as.matrix(round(prop.table(comm_stat.org_str.reg.ftbl, margin=1)*100, digits=1)))
```
...
```{r, echo=FALSE, results='asis'}
kable(as.matrix(round(prop.table(comm_stat.org_str.busi.ftbl, margin=1)*100, digits=1)))
```
