...
ecdf.5 <- ecdf.4 + ggtitle("공동체상태와 업력") + theme(text=element_text(family="Apple SD Gothic Neo"))
...
ecdf.11 <- ecdf.10 + annotate("segment", x=1.3, xend=4.39, y=0.5, yend=0.5, colour="blue", arrow=arrow(ends="both", length=unit(0.2, "cm")))
...
poly.11 <- poly.10 + scale_x_continuous(breaks=c(0, 1.3, 4.39, 11.6, 12.3), labels=c(0, 1.3, 4.39, 11.6, 12.3))
